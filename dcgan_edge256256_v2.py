...
if __name__ == '__main__':
    # 파라미터 초기화
    data_dir = "D:\\meter\\meter_dataset\\meter_images_2160"
    ...
    for epoch in range(epochs):
        ...
        cv2.imwrite("./train/{}.png".format(epoch), gen_images[0]*255.)
        ...
        if epoch>=60:
            ...
            if num=="y":
                try:
                    gen_model.save("generator_model_{}.hdf5".format(epoch))
                    print("GENERATOR MODEL SAVE")
                    #dis_model.save("discriminator_model.hdf5")
                    #print("DISCRIMINATOR MODEL SAVE")
