...
def build_generator():
    ...
    gen_model.add(Reshape((8, 8, 256), input_shape=(8*8*256,)))
...
if __name__ == '__main__':
    ...
    gen_optimizer=Adam(lr=0.0001, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.0, amsgrad=False)
    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0:
            ...
            for img in gen_images1[:2]:
                #save_rgb_img(img)
                cv2.imwrite("./results/one_{}.png".format(epoch), (img * 255).astype(np.uint8))
